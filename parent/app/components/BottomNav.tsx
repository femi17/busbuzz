 ...
 * Rendered on every primary screen so navigation stays put as you move
 * between Track, History, Alerts and the child profile.
 */
export default function BottomNav({
  ...
  return (
    <nav className={styles.nav} aria-label="Primary">
      <a className={cx(active === "track")} href="/" aria-current={active === "track" ? "page" : undefined}>
      ...
      <a className={cx(active === "history")} href="/history" aria-current={active === "history" ? "page" : undefined}>
        <svg className={styles.ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 8v4l3 2" />
      ...
      <a className={cx(active === "alerts")} href="/alerts" aria-current={active === "alerts" ? "page" : undefined}>
        <svg className={styles.ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <a className={cx(active === "child")} href="/child" aria-current={active === "child" ? "page" : undefined}>
        <svg className={styles.ic} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
